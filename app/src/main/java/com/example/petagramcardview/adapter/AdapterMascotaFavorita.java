package com.example.petagramcardview.adapter;
...
import com.example.petagramcardview.MascotaFavorita;
import com.example.petagramcardview.R;
...
public class AdapterMascotaFavorita extends RecyclerView.Adapter<AdapterMascotaFavorita.ViewHolderMascota> {
    ...
    public ViewHolderMascota onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.second_item_list, null,false);
